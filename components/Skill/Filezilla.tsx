  ...
  return (
    <div className='group relative flex cursor-pointer'>
      <motion.img
        ...
        src="./images/filezilla.png"
        className='rounded-full border border-gray-500 object-cover w-20 h-20 xl:w-24 xl:h-24 filter group-hover:grayscale transtion duration-50 ease-in-out'
      />
