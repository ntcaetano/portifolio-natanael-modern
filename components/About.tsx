...
export default function About({}: Props) {
  return (
    ...
    className='flex xl:flex-row lg:flex-row flex-col relative h-screen text-center md-text-left md-flex-row max-w-4xl px-10 justify-evenly mx-auto items-center'
    >
        ...
        className='-mb-20 md:mb-0 xl:mt-24 lg:mt-24 mt-32 flex-shrink-0 w-56 h-56 rounded-full object-cover md:rounded-lg md:w-64 md:h-95 xl:w-[300px] xl:h-[400px]'
        />
